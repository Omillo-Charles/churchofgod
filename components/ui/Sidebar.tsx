...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Drawer */}
      <div
        className={`fixed top-0 left-0 w-full max-w-sm h-screen bg-white dark:bg-zinc-950 z-[70] shadow-2xl transition-transform duration-500 ease-in-out overflow-y-auto no-scrollbar ${
          isOpen ? "translate-x-0" : "-translate-x-full"
        }`}
      >
        <div className="min-h-full flex flex-col">
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-zinc-100 dark:border-zinc-900 sticky top-0 bg-white dark:bg-zinc-950 z-10">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-lg text-zinc-900 dark:text-white">NTCOGK</span>
            </div>
            <button
              onClick={onClose}
                    ...
                    return (
                      ...
                      >
                        <h4 className={`text-sm font-bold transition-colors ${
                          isActive ? "text-amber-500" : "text-zinc-900 dark:text-zinc-100 group-hover:text-zinc-600 dark:group-hover:text-zinc-400"
                        }`}>
                          {link.name}
                        </h4>
          ...
          {/* Footer Socials */}
          <div className="mt-auto p-6 bg-zinc-50 dark:bg-zinc-900/50 border-t border-zinc-100 dark:border-zinc-900 flex items-center justify-between">
