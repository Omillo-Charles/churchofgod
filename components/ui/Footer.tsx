  ...
  return (
    <footer className="bg-zinc-50 dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-900 pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 space-y-8">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-lg md:text-xl font-bold tracking-tight text-zinc-900 dark:text-white leading-none">
                  NTCOGK
                </span>
            ...
            <div className="max-w-sm">
              <h4 className="text-xs md:text-sm font-bold text-zinc-900 dark:text-zinc-100 mb-3">
                Stay Connected
              </h4>
              <p className="text-[10px] md:text-sm text-zinc-600 dark:text-zinc-400 mb-4 leading-relaxed font-medium">
              ...
              <form className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 rounded-xl text-[10px] md:text-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-zinc-900/10 dark:focus:ring-white/10 transition-all"
                />
                <button className="px-5 py-2.5 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-xl text-[10px] md:text-sm font-bold hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-all active:scale-95">
                  Join
                </button>
              </form>
            </div>
          ...
          {footerSections.map((section) => (
            <div key={section.title} className="space-y-6">
              <h4 className="text-xs font-bold text-zinc-400 dark:text-zinc-500">
                {section.title}
              </h4>
              <ul className="space-y-4">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-[11px] md:text-sm font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors"
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        {/* Contact & Socials Bar */}
        <div className="pt-8 border-t border-zinc-200 dark:border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-[10px] md:text-xs font-bold text-zinc-500 dark:text-zinc-500">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-6 text-zinc-500 dark:text-zinc-500">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 text-[9px] md:text-xs">
            ...
            <p className="flex items-center gap-1.5 font-bold text-zinc-400">
              ...
              <a
                ...
                className="text-zinc-900 dark:text-white font-black hover:underline transition-all"
              >
                OMYT3CH
              </a>
            </p>
