        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h2 className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-600 dark:text-amber-500">
                Our Purpose
              </h2>
              <h3 className="text-xl md:text-3xl font-black tracking-tight text-zinc-900 dark:text-white leading-[1.1]">
                Empowering Lives Through <br />
                <span className="text-zinc-400">Authentic Faith.</span>
              </h3>
            </div>
            
            <p className="text-[11px] md:text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed font-medium">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
              <div className="space-y-3">
                ...
                <h4 className="text-[11px] md:text-xs font-bold text-zinc-900 dark:text-white">Integrity & Care</h4>
                <p className="text-[9px] md:text-[10px] text-zinc-500 dark:text-zinc-500 leading-normal">
              ...
              <div className="space-y-3">
                ...
                <h4 className="text-[11px] md:text-xs font-bold text-zinc-900 dark:text-white">Evangelism</h4>
                <p className="text-[9px] md:text-[10px] text-zinc-500 dark:text-zinc-500 leading-normal">
            ...
            <div className="pt-6">
              <Link
                href="/about"
                className="inline-flex items-center gap-2 text-[10px] md:text-xs font-bold text-zinc-900 dark:text-white hover:gap-4 transition-all"
              >
