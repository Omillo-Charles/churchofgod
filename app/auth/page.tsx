...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-950 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full max-w-md space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="space-y-3">
            <div className="lg:hidden flex items-center gap-3 mb-8">
              ...
              <span className="text-lg font-black text-zinc-900 dark:text-white uppercase tracking-tight">NTCOGK</span>
            </div>
            
            <h1 className="text-2xl font-black text-zinc-900 dark:text-white uppercase tracking-tight">
              {mode === "login" ? "Welcome Back" : "Create Account"}
            </h1>
            <p className="text-zinc-500 dark:text-zinc-500 text-xs md:text-sm">
              {mode === "login" 
          ...
          <div className="space-y-6">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              {mode === "signup" && (
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-5 py-3.5 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl text-xs focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none transition-all placeholder:text-zinc-400"
                  />
                </div>
              )}
              ...
              <button className="w-full py-4 bg-zinc-900 dark:bg-white text-white dark:text-black font-black uppercase tracking-widest text-[10px] rounded-2xl hover:scale-[1.02] active:scale-95 transition-all shadow-xl shadow-zinc-900/10 dark:shadow-white/5 mt-4">
                {mode === "login" ? "Sign In to Portal" : "Create Account"}
              </button>
            </form>

            <div className="relative py-4 flex items-center justify-center">
              <div className="absolute inset-x-0 h-px bg-zinc-100 dark:bg-zinc-800" />
              <span className="relative px-4 bg-white dark:bg-zinc-950 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Or continue with</span>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-3 px-6 py-3 border border-zinc-200 dark:border-zinc-800 rounded-2xl hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors group">
                ...
                <span className="text-[10px] font-bold text-zinc-900 dark:text-white uppercase tracking-widest">Google</span>
              </button>
              <button className="flex items-center justify-center gap-3 px-6 py-3 border border-zinc-200 dark:border-zinc-800 rounded-2xl hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors group">
                <svg className="w-4 h-4 fill-zinc-900 dark:fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-[10px] font-bold text-zinc-900 dark:text-white uppercase tracking-widest">Github</span>
              </button>
            </div>
          </div>

          <div className="text-center">
            <Link href="/" className="text-[10px] font-bold text-zinc-400 hover:text-zinc-900 dark:hover:text-white uppercase tracking-[0.3em] transition-colors">
              Return to Homepage
            </Link>
          </div>
        </div>
