...
const AboutPage = () => {
  ...
  return (
    <div className="bg-black min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6 md:space-y-8">
              <div className="space-y-2">
                ...
                <h2 className="text-xl md:text-2xl font-black text-white uppercase">Established on Faith</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                <div className="p-5 md:p-6 bg-zinc-900 rounded-3xl border border-zinc-800">
                  <p className="text-[9px] font-bold text-amber-500 uppercase tracking-widest mb-1">Founded</p>
                  <p className="text-xs md:text-sm font-bold text-white">1977 in Karatina</p>
                </div>
                <div className="p-5 md:p-6 bg-zinc-900 rounded-3xl border border-zinc-800">
                  <p className="text-[9px] font-bold text-amber-500 uppercase tracking-widest mb-1">Global HQ</p>
                  <p className="text-xs md:text-sm font-bold text-white">Cleveland, Tennessee</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto space-y-12 md:space-y-16">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start">
              ...
              <div className="md:col-span-8 space-y-3">
                <p className="text-sm md:text-base font-bold text-white">The Church of God movement began in the United States with only eight men.</p>
                <p className="text-[11px] md:text-xs text-zinc-400 leading-relaxed">It has since grown into a worldwide denomination spreading the gospel across all continents.</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start">
              <div className="md:col-span-4 text-[10px] font-black uppercase tracking-[0.3em] text-amber-500 pt-1">1977 Kenya Foundation</div>
              <div className="md:col-span-8 space-y-3">
                <p className="text-sm md:text-base font-bold text-white">Established on May 13, 1977 in Karatina, Nyeri District by Founder Francis Gachara.</p>
                <p className="text-[11px] md:text-xs text-zinc-400 leading-relaxed">Claudea served as the first missionary National Overseer, marking the beginning of a transformative ministry in East Africa.</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8 mt-16 md:mt-24">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center p-6 md:p-8 bg-zinc-900 rounded-[2rem] md:rounded-[2.5rem] border border-zinc-800 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 text-left">
            {regions.map((region) => (
              <div key={region.name} className="p-6 md:p-8 bg-zinc-900 rounded-3xl border border-zinc-800 hover:border-amber-500/20 transition-all">
                ...
                <h4 className="text-sm md:text-base font-bold text-white mb-1">{region.bishop}</h4>
      ...
      {/* Final Closing */}
      <section className="py-16 md:py-24 text-center space-y-6 md:space-y-8 bg-black">
        <div className="max-w-2xl mx-auto px-6 space-y-3 md:space-y-4">
          ...
          <div className="pt-6 md:pt-8">
            <h2 className="text-lg md:text-2xl font-black text-white uppercase tracking-[0.2em]">To God be the Glory!</h2>
          </div>
        </div>
      </section>
    </div>
